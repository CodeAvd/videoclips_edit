...
from app.api.v1.endpoints import brand_profiles, candidate_clips, health, jobs, platform_accounts, proof_harness, source_videos, transcripts, uploads
...
api_router.include_router(proof_harness.router, tags=["proof-harness"])
